...
weekly config in `configTable.slots` field:
```typescript
{
  slots: {
    weeklyConfig: {
      monday: [
        { from: "09:00:00", to: "10:00:00", status: "available", fullAmount: 500_00, advanceAmount: 100_00 },
        { from: "10:00:00", to: "11:00:00", status: "available"},
        // ... more slots
      ],
      tuesday: [
        { from: "09:00:00", to: "10:00:00", status: "available", fullAmount: 600_00, advanceAmount: 150_
        ....


    },
    avoidSlots: [
      { from: "12:00:00", to: "14:00:00", date: "2025-12-25" }, // Maintenance on Christmas
      // ... more avoid slots
    ],
    fullAmountDefault: 800_00,
    advanceAmountDefault: 100_00,
