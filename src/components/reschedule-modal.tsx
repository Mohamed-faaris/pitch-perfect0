...
export default function RescheduleModal({
  ...
  onClose: () => void
  onSave: (updated: { id: string; date: string; slot: string }) => void
}) {
  ...
  const handleSave = () => {
    const updated = { ...booking, date: dateIso, slot: slot! }
    try {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-slate-900 rounded-t-xl p-4 w-full max-w-md shadow-xl max-h-[80vh] overflow-y-auto">
